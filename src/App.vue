<template>
  <v-app>
    <v-container class="home-width" v-if="currentRouteName === 'home'">
      <img :src="publicPath + 'images/tunico-logo.png'" class="img-fluid w-100 mt-15 mb-3" />
    </v-container>
    <v-container :class="{'max-width': !mainData.options.fullWidth, 'd-flex': true, 'pb-0': true}" :fluid="!mainData.wideScreen" v-else>
      <router-link to="/"><img :src="publicPath + 'images/tunico-logo.png'" class="img-fluid logo-small mt-1" /></router-link>
      <v-spacer />
